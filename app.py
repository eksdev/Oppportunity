...
\
                ### How It Works\
                1. **Ticker Input**:\
                   You begin by entering the stock tickers you want to analyze in the \'93Analysis\'94 tab. Each ticker\
                   is gathered and used in a series of computational \'93tests.\'94\
\
                2. **Selected Tests**:\
                   Under \'93Select Tests To Include,\'94 you can decide which metrics or tests are relevant to your\
...
\
                ### Tests & Metrics\
                 1. **Short Interest %**  \
                   - Measures the percentage of a company\'92s float that is held by short sellers.  \
...
\
                4. **Insider Ownership**  \
                   ...
                   - Higher insider ownership can suggest strong confidence from management in the company\'92s prospects.\
\
...
\
                6. **Momentum**  \
                   - Evaluates how quickly a stock\'92s price is moving, often based on average returns over a certain period.  \
                   - Positive momentum can suggest strong short-term investor demand.\
\
                7. **Beta**  \
                   - A measure of a stock\'92s volatility compared to the broader market.  \
...
\
                9. **ROE** (Return on Equity)  \
                   - Calculated as net income divided by shareholders\'92 equity.  \
...
\
                15. **Price / Earnings**  \
                    ...
                    - Provides a quick snapshot of how the market values the company\'92s earnings.\
\
                16. **Debt/Equity**  \
